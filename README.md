...
3. Theoretical Arguments / Experiments  
a. Gather theoretical assumptions about the architecture of FFNs
b. Use the theory to argue and predict what might cause the limitations in explainability
c. Test these theoretical hypotheses
